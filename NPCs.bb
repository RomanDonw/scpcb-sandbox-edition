				...
				If Curr173\Idle <> 3 Then
					...
					If n\Idle < 2 Then
						...
						If n\Idle = False Then
							...
							If move=False Then
								If EnableSCP173HorrorEffects Then
								...
								If dist < 3.5 And MilliSecs2() - n\LastSeen > 60000 And temp Then
									If EnableSCP173HorrorEffects PlaySound_Strict(HorrorSFX(Rand(3,4)))
									
									n\LastSeen = MilliSecs2()
								EndIf
								
								If dist < 1.5 And Rand(700) = 1 and EnableSCP173HorrorEffects Then PlaySound2(Scp173SFX(Rand(0, 2)), Camera, n\obj)
								
								If dist < 1.5 And n\LastDist > 2.0 And temp and EnableSCP173HorrorEffects Then
									CurrCameraZoom = 40.0
							...
							Else
								...
								If dist > 50 and EnableSCP173Teleporting Then
									If Rand(70)=1 Then
										...
										EndIf
									EndIf
								ElseIf dist > HideDistance*0.8 and EnableSCP173Teleporting ;3-6 rooms away from the player -> move randomly from waypoint to another
...
Function UpdateMTFUnit(n.NPCs)
	...
	;If Not UpdatingMTFEnabled Return
