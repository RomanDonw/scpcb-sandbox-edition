...
Function UpdateMainMenu()
	...
	AAText 20,GraphicHeight-30,"Version "+VersionNumber
...
Function DrawLoading(percent%, shortloading=False)
	...
	Repeat 
		...
		If (Not SelectedLoadingScreen\disablebackground) or (not EnableLoadingScreens) Then
		...
		If EnableLoadingScreens DrawImage SelectedLoadingScreen\img, x, y
		...
		If SelectedLoadingScreen\title = "CWM" and EnableLoadingScreens Then
			...
			If percent = 0 and EnableLoadingScreens Then 
				If Rand(5)=1 Then
					Select Rand(2)
						Case 1
		...
		If percent = 100 Then 
			If firstloop And SelectedLoadingScreen\title <> "CWM" and EnableMenuPressAnyKeySound Then PlaySound_Strict LoadTempSound(("SFX\Horror\Horror8.ogg"))
