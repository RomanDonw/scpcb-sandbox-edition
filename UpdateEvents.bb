...
Function UpdateEvents()
	...
	For e.Events = Each Events
		Select e\EventName
			...
			Case "173" ;the intro sequence
				...
				If KillTimer >= 0 And e\EventState2 = 0 Then
					...
					If e\EventState3>0 Then
						...
						If e\EventState3 < 170 Then
							If e\EventState3 = 1.0 Then
								...
								If IntroSequenceMusic MusicCHN = StreamSound_Strict("SFX\Music\"+Music(13)+".ogg",CurrMusicVolume,Mode)
					...
					Else
						...
						;[Block]
						If e\EventState = 0 and (Not DestroyIntroSequence) Then
							If PlayerRoom = e\room Then
								...
								e\EventState3 = 1
							EndIf
						ElseIf e\EventState < 10000 and (Not DestroyIntroSequence) Then
							;Curr173\Idle = False
							...
							ResetEntity(Curr173\Collider)
						ElseIf e\EventState < 14000 and (Not DestroyIntroSequence) Then; player is inside the room
							...
							RotateEntity(Curr173\Collider, 0, 0, 0, True)
							ResetEntity(Curr173\Collider)
						ElseIf e\EventState < 20000 and (Not DestroyIntroSequence) Then
							pvt% = CreatePivot()
							...
							Else
								...
								EndIf
							End If
						ElseIf e\EventState < 30000 and (Not DestroyIntroSequence) Then
			...
			Case "room2tesla"
				;[Block]
				If DisableTeslaSequence Then e\EventStr = "done"
